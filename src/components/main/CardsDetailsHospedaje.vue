...
const item = hospedajes.find((h) => h.id === id) || hospedajes[0];
...
function reserve() {
  // simple reservation flow: navigate to hospedajes list or to a reservation route
  router.push({ path: "/hospedajes" });
}

function goBack() {
  // navigate back to hospedajes listing
  router.push({ path: "/hospedajes" });
}
</script>
